...
function insert_events(desc){
  let new_tr = new_element('tr',{},
  [new_element('td', {'style': 'text-align: center; vertical-align: middle;'}, [document.createTextNode(desc['last_name']+', ' + desc['first_name'])]),
  new_element('td', {'style': 'text-align: center; vertical-align: middle;'}, [document.createTextNode(desc['city'])]),
  new_element('td', {'style': 'text-align: center; vertical-align: middle;'}, [document.createTextNode(desc['email')]),
